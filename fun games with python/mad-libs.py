from numpy import choose, dtype
...
class Mad_lib:
    ...
    def chose_the_game(self):
        print("Which game you want to play?")
        print("1 or 2 or 3")
        self.choose = input("type the number")

        if int(self.choose) == 1:
            self.game1()
        elif(int(self.choose) == 2):
            self.game2()
        elif(int(self.choose) == 3):
            self.game3()
        else:
